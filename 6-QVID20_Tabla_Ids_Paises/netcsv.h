...
private:
    ...
    int existe_dato(QList<QStringList> tabla, QStringList dato, int posicion_inicial, int posicion_final);
    int comp_string_fecha(QString fechaA, QString fechaB);
    QList<int> obtener_posiciones_paises(QList<QStringList> tabla);
    QList<int> obtener_posiciones_regiones(QList<QStringList> tabla);
