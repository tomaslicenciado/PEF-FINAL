...
private:
    ...
    int existe_dato(const QList<QStringList>* tabla, QStringList dato, int posicion_inicial, int posicion_final);
    //int comp_string_fecha(QString fechaA, QString fechaB);
    QList<int> obtener_posiciones_paises(const QList<QStringList>* tabla);
